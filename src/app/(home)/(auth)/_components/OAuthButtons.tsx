  ...
  return (
    <div className="mt-4 text-center">
      ...
      <div className="flex justify-center mt-2 space-x-4">
        ...
        >
          <Image src="/images/OAuthLogos/GoogleLogo.png" alt="Google" width={24} height={24} />
        </button>
        <button
          onClick={() => handleLogin('kakao')}
          className="bg-yellow-400 p-2 rounded-full flex items-center justify-center w-12 h-12"
        >
          <Image src="/images/OAuthLogos/KakaoLogo.png" alt="Kakao" width={24} height={24} />
        </button>
        <button
          onClick={() => handleLogin('github')}
          className="bg-black p-2 rounded-full flex items-center justify-center w-12 h-12"
        >
          <Image src="/images/OAuthLogos/GithubLogo.png" alt="GitHub" width={24} height={24} />
        </button>
      </div>
    </div>
  );
